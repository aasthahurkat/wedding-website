...
export default function HomePage() {
  ...
  useEffect(() => {
    if (router.isReady && !valid) router.replace("/404");
    ...
    <>
      ...
      <AnimatePresence>
        {coverVisible && (
          ...
          >
            <CoverBoard onAnimationComplete={() => setCoverVisible(false)} />
          </motion.div>
        )}
      </AnimatePresence>
              ...
              <section className="md:hidden bg-ivory px-4 py-12">
                <div className="max-w-prose mx-auto space-y-4 text-center">
                  ...
                  <div className="prose prose-md mx-auto space-y-4">
                    <p>
                      We’re so excited to share this corner of the internet with you—where you’ll find all the details, joyful chaos, and surprises leading up to our big day in December 2025, back home in Indore where our next chapter begins. Over the coming months, this site will guide you through every celebration, the color palettes, the outfits, and those little surprises we’ve planned.
                      <br />
                      We’ve built it with love—and a little nerdy flair—you’ll spot bits of us in the design, the themes, and in our words. It’s more than an itinerary; it’s our story, shared with the people who matter most.
                      <br />
                      We can’t wait to dance, laugh, cry (a little), and celebrate with you!
                    </p>
                  ...
                  <div className="w-1/2 flex flex-col items-center text-center">
                    ...
                    <div className="prose prose-lg max-w-[50ch] space-y-4">
                      <p>
                        We’re so excited to share this corner of the internet with you—where you’ll find all the details, joyful chaos, and surprises leading up to our big day in December 2025, back home in Indore where our next chapter begins. Over the coming months, this site will guide you through every celebration, the color palettes, the outfits, and those little surprises we’ve planned.
                        <br />
                        We’ve built it with love—and a little nerdy flair—you’ll spot personal touches in the design, the themes, and in our words. It’s more than an itinerary; it’s our story, shared with the people who matter most.
                        <br />
                        We can’t wait to dance, laugh, cry (a little), and celebrate with you!
                      </p>
