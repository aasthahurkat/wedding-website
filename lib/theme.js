...
export const BRIDE_THEME = {
  // Navigation
  navBackground: 'bg-sky-100/98',
  mobileBackground: 'bg-sky-100/98',
...
export const DEFAULT_THEME = {
  // Navigation
  navBackground: 'bg-ivory/98',
  mobileBackground: 'bg-ivory/98',
  ...
  hamburgerBar: 'bg-burgundy',
  focusRing: 'focus:ring-burgundy',
