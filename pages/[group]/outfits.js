    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 relative bg-cream">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-navy/70 max-w-2xl mx-auto text-sm sm:text-base px-4">{outfitData.subtitle}</p>
        </div>
            ...
            >
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-grow">
                  <h3 className="text-lg sm:text-xl font-serif text-navy mb-3">{section.event}</h3>
        ...
        {current === 'friends' && (
          <div className="mt-8 sm:mt-12">
            <h2 className="text-xl sm:text-2xl font-serif text-navy text-center mb-6 sm:mb-8 px-4">Shopping Recommendations in Indore</h2>
            <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {outfitData.stores.map((store, index) => (
                <div key={index} className="bg-ivory rounded-lg shadow-lg p-6 border border-neutral/20">
        ...
        {current === 'friends' && (
          <div className="mt-8 sm:mt-12">
            <h2 className="text-xl sm:text-2xl font-serif text-navy text-center mb-6 sm:mb-8 px-4">Rental Options in Indore</h2>
        ...
        <div className="mt-12 text-center">
          <div className="bg-burgundy/10 rounded-lg p-6 max-w-2xl mx-auto">
            <p className="text-navy/80 text-sm leading-relaxed">
              We can't wait to see you dressed up and celebrating with us! If you have any questions about outfits or need shopping recommendations, please don't hesitate to ask.
            </p>
          </div>
        </div>
        </div>
